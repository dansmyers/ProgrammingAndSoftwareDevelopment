...
2. A set of **six programming assignments**, one due approximately every two weeks.

3. **Challenge problems**, roughly one per assignment, which are somewhat more complex than the regular homework questions and require you to stretch a little bit.

4. A **final project**, which we'll start during the last two weeks of class.

5. **Midterm and final exams**. The final covers the second half of class.
...
- Pass, with a score of 60% or higher, the midterm and final exams.

To earn a C:

- Complete the requirements for a D.
- Satisfactory completion of at least five of the six programming assignments.
...
- Satisfactory completion of the final programming project.
